...
void PrintDamageOnScreenHP(DWORD a,DWORD b,DWORD c,DWORD d,DWORD e,DWORD f,DWORD g);
void PrintDamageOnScreenSD(DWORD a,DWORD b,DWORD c,DWORD d,DWORD e,DWORD f,DWORD g);
void PrintDamageOnScreenRF(DWORD a,DWORD b,DWORD c,DWORD d,DWORD e,DWORD f,DWORD g);
void PrintDamageOnScreenED(DWORD a,DWORD b,DWORD c,DWORD d,DWORD e,DWORD f,DWORD g);
...
void PrintPlayerDarkHorseDamage();
void PrintPlayerDarkHorseSpeed();
void PrintPlayerDarkSpiritDamage();
void PrintPlayerDarkSpiritSpeed();
