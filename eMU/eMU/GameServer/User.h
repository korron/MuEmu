...
extern MESSAGE_STATE_MACHINE gSMMsg[MAX_OBJECT][MAX_MONSTER_SEND_MSG];

//extern MESSAGE_STATE_MACHINE_HEADER gSMMsg;

extern MESSAGE_STATE_ATTACK_MACHINE gSMAttackProcMsg[MAX_OBJECT][MAX_MONSTER_SEND_ATTACK_MSG];
